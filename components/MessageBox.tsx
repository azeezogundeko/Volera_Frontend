...
const MessageBox = ({
  ...
  return (
    <div className="w-full overflow-x-hidden relative" ref={messageRef}>
      {/* Main Content Area */}
      <div className="w-full lg:w-[calc(125%-20rem)] pl-0">
        {message.role === 'user' && (
            ...
            <div className="flex items-start px-0 max-w-3xl mx-auto">
              ...
              <div className="flex-1 min-w-0 pl-2">
                <div className="flex flex-col space-y-4">
                  {/* Modified container: transparent background instead of bg-light-100/dark:bg-dark-100 */}
                  <div className="bg-transparent rounded-xl p-4">
                    {message.sources && message.sources.length > 0 && (
                      <div className="mt-4 p-4 bg-transparent rounded-xl">
