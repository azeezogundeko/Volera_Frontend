              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative group">
                  <input
                    ...
                    className="relative z-10 w-full px-6 py-4 bg-white/5 border border-white/10 rounded-xl placeholder-gray-500 focus:outline-none focus:border-emerald-500/50 transition-all"
                  />
                ...
                <button className="relative px-8 py-4 overflow-hidden group bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 rounded-xl transition-all duration-300">
          ...
          <div className="relative bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent rounded-3xl overflow-hidden">
            <div className="relative z-10 px-6 py-12 md:px-16 md:py-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <span className="text-gray-400 text-sm flex items-center gap-2 sm:hidden">
